...
from wtforms import StringField, BooleanField, PasswordField, HiddenField, SubmitField, SelectField, TextAreaField, DateField, FileField, DecimalField, IntegerField
